...
class MoreMso(Base):
    ...
    approve_name: Mapped[str | None] = mapped_column(String(255))
    approve_number: Mapped[str | None] = mapped_column(String(255))
    approve_date: Mapped[date | None] = mapped_column(Date)
