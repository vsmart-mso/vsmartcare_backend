...
Revision ID: 0058_case_data_edit_logs
Revises: 0057_review_field_ktb_fix_id
Create Date: 2026-06-12

สาขา parallel จาก 0057 — merge ที่ 0060_case_data_edit_logs กับ 0059_admin_province_access
"""
...
revision: str = "0058_case_data_edit_logs"
...
def upgrade() -> None:
    ...
    if "case_data_edit_logs" in inspector.get_table_names():
        return
